...
ratios = [0.05+0.08475+2.58537*i for i in ratios]
...
map = plt.contourf(X,Y,ratio_mat-.05, np.arange(0.4,1.11,0.1))#np.arange(0.0,14,1))# 
...
plt.contour(X,Y,ratio_mat-.05,[0.72,100],colors=[[1,0,0]],linestyles=['--'],label='Baseline')
