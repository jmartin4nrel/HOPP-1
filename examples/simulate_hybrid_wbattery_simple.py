...
solar_file = examples_dir / "resource_files" / "solar_m2_2019.csv"
wind_file = examples_dir / "resource_files" / "wind_m5_2019_1atm.srw"
...
output_df.to_csv(examples_dir / ("Outputs_"+solver+".csv"))
